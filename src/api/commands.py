    ...
    def fill_db_with_example_data():
        ...
        try:
            ...
            questions = [
                ...
                Question(image="https://res.cloudinary.com/dq4dla9gj/image/upload/taj_mahal2", information="The Taj Mahal in Agra, India, is an iconic white marble mausoleum. Built in the 17th century by Mughal Emperor Shah Jahan in memory of his wife, Mumtaz Mahal, it's renowned for its stunning architecture and intricate details. It's considered one of the world's most beautiful buildings and a symbol of eternal love.", country_id=countries[8].id),
                ...
                Question(image="https://res.cloudinary.com/dq4dla9gj/image/upload/louvre2", information="The Louvre Museum in Paris, France, is one of the world's largest and most visited art museums. Housed in a historic palace, it showcases thousands of artworks, including the Mona Lisa and the Venus de Milo. The Louvre is a symbol of art and culture and a must-visit destination for art enthusiasts.", country_id=countries[6].id),
