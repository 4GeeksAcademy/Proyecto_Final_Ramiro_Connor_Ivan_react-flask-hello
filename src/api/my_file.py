...
def uploadImage():
  ...
  cloudinary.uploader.upload("https://images.pexels.com/photos/2675266/pexels-photo-2675266.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1", public_id="louvre", unique_filename = False, overwrite=True)
  ...
  louvre = CloudinaryImage("louvre").build_url()
