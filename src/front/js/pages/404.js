    ...
    <div className="container">
            <div className="content">
                ...
                <div className="error">
                    ...
                    <div className="error__subtitle">{t('notFound.part1')}</div>
                    <div className="error__description">{t('notFound.part2')}</div>
                    <Link to="/">
                        <button className="error__button error__button--active">{t('notFound.part3')}</button>
                    </Link>
                </div>
