    ...
    return (
        <div className="Loginwrapper back-texto2 d-flex justify-content-center  ">
            <div className="Cajaform cambria   back-texto3" >
                ...
                <h1 className="FormHeader text-center mb-3 recupera">{t('password.part1')}</h1>
                <form className="mb-4" onSubmit={recuperando}>
                    ...
                    <button type="submit" className="login mb-5" disabled={desactivado}>{t('password.part2')}</button>
                    </div>
                </form>
